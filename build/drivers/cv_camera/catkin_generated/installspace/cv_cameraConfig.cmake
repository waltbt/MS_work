...
if("FALSE" STREQUAL "TRUE")
  set(cv_camera_SOURCE_PREFIX /home/ben/gripper_proj_py/src/drivers/cv_camera)
  set(cv_camera_DEVEL_PREFIX /home/ben/gripper_proj_py/devel)
  ...
  set(cv_camera_INSTALL_PREFIX /home/ben/gripper_proj_py/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ben/gripper_proj_py/install/${idir}'.  ${_report}")
    endif()
