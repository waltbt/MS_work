...
if("FALSE" STREQUAL "TRUE")
  set(depth_image_proc_SOURCE_PREFIX /home/ben/gripper_proj_py/src/drivers/camera_calibration/image_pipeline/depth_image_proc)
  set(depth_image_proc_DEVEL_PREFIX /home/ben/gripper_proj_py/devel)
  ...
  set(depth_image_proc_INSTALL_PREFIX /home/ben/gripper_proj_py/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'depth_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ben/gripper_proj_py/install/${idir}'.  ${_report}")
    endif()
